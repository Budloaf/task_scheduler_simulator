...
To set device service times, enter the device letter (a-d) 
followed by a space and the service time in ms. 
You may enter more than one device and service time by separating names and times with spaces. 
For example:
